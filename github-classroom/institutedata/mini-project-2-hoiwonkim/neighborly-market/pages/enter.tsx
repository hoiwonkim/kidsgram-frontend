// ./neighborly-market\pages\enter.tsx
...
const Enter: NextPage = () => {
  ...
  return (
    <div className="mt-16 px-4">
      <h3 className="text-3xl font-bold text-center">🍎Enter to Apple🍎</h3>
      <div className="mt-12">
        {data?.ok ? (
          <form
            onSubmit={tokenHandleSubmit(onTokenValid)}
...
const Enter: NextPage = () => {
  ...
  return (
    <div className={`${styles["bg-apple-pattern"]} bg-pink-100 flex flex-col space-y-5 divide-y`}>
      <h3 className="text-3xl font-bold text-center">🍎Enter to Apple🍎</h3>
      <div className="mt-12">
        {data?.ok ? (
          <form
