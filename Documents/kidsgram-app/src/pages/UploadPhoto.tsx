...
const UploadPhoto = () => {
  ...
  const onValid = (): void => {
    ...
    uploadPhotoMutation({ variables: { photo: photo[0], caption: text } })
      .then((value) => {
        console.log("uploadPhotoMutation success value: ", value)
      })
      .catch((reason) => {
        console.log("uploadPhotoMutation failure reason: ", reason)
      })
    ;
  };
  ...
  return (
    <>
      ...
      <AnimatePresence>
        ...
        <ModalBox onSubmit={handleSubmit(onValid, onInvalid)} variants={modalVariants} initial="start" animate="end" exit="exit">
          <ModalHeader>
            <h2>새 게시물 만들기</h2>
...
export default UploadPhoto;function useCallback(arg0: () => void) {
